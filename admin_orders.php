...
if(isset($_POST['update_orders'])){
   ...
   $order_update_payment=$_POST['update_payment'];
   mysqli_query($conn, "UPDATE `orders` SET payment_stauts='$order_update_payment' WHERE id = '$order_update_id'") or die('query failed');
...
while($fetch_orders=mysqli_fetch_assoc($select_orders)){
     ...
     <div class="box">
         ...
         <p id="hi"> email:<span><?php echo $fetch_orders['email']; ?></span></p>
         ...
         <form action="" method="POST">
          ...
          <option value="" selected disabled><?php echo $fetch_orders['payment_stauts']; ?></option>
